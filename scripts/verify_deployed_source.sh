...
#
# Compares the source the network actually holds against contracts/SubstituteProof.py.
...
ADDR="${1:-${VITE_CONTRACT_ADDRESS:-0x2E07cA0D78D3Ec9D0AFa67b82df5E0570F816C78}}"
SRC="${CONTRACT_PATH:-contracts/SubstituteProof.py}"
...
echo "SubstituteProof deployed-source parity check (newline-aware)"
echo "RPC:      $RPC"
echo "Contract: $ADDR"
echo "Source:   $SRC"
