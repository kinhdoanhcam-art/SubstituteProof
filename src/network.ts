 ...
 * studio-dev; Studio Next is served from a different host. Overriding the RPC on
 * a copy of that preset keeps the v0.6 wiring and moves only the endpoint, so a
 * transaction can never be signed for a different chain than the one being read.
 */
