...
Evidence is stored under `verification-evidence/`.

## Frontend
- functional React/Vite workspace: COMPLETE
- light editorial agreement-workspace visual system: COMPLETE
- `Verification Path` evidence page: COMPLETE
- final deployment address embedded: YES
- verified agreement shortcut: YES
...
## Remaining before final submission freeze
1. Push this package to GitHub.
2. Let Vercel install dependencies and run `npm run build`.
3. Smoke-test Overview, Verification Path, wallet connect, verified agreement loading, and role/status rendering.
